    ...
    <>
      <div className="overviewer-nav">
        ...
        {windowDimensions.width >= 1001 && (
          <div style={{ paddingRight: 5, paddingLeft: 55 }}>
            <svg onClick={() => window.open("https://discord.gg/gridcraft")} style={{ paddingLeft: 15, paddingRight: 15 }} width="30" height="23" viewBox="0 0 30 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg onClick={() => window.open("https://www.twitter.com/gridcraft")} style={{ paddingLeft: 45, paddingRight: 15 }} width="30" height="25" viewBox="0 0 30 25" fill="none" xmlns="http://www.w3.org/2000/svg">
