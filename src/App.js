    ...
    <>
      <div className="overviewer-nav">
        ...
        <div style={{ position: 'absolute', left: 20 }}>
          <a href="#" title="Gridcraft Discord" onClick={() => window.open("https://discord.gg/gridcraft")}>
            <svg style={{ paddingLeft: '1rem', paddingRight: '1rem' }} width="30" height="23" viewBox="0 0 30 23" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="#" title="Gridcraft Twitter" onClick={() => window.open("https://www.twitter.com/gridcraft")}>
            <svg style={{ paddingLeft: '2rem', paddingRight: '1rem' }} width="30" height="25" viewBox="0 0 30 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <iframe
        id="map_1"
        className="map"
        src="https://grid-overviewer-staging.projecki.com/#/0/64/-0/-4/minecraft%20-%20overworld/day"
